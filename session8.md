...
این آزمایش شامل موارد زیر باشد. (جهت پیاده‌سازی این آزمایش، از ورژن ۴ لینوکس (با ubuntu-18.04.6-live-server-amd64 تست شده‌است.) استفاده کنید تا به مشکل کم‌تری برخورد کنید.)
